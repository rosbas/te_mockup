<template>
  <div>
    ...
    <div class='max-w-sm -mt-6 mb-10 w-full h-auto justify-center bg-white shadow-xl rounded-lg overflow-hidden mx-auto flex flex-col p-5 space-y-5'>
      <Name/>
      <Date/>
      <!-- <button class="px-6 py-4 m-auto bg-pink-200 rounded-xl text-white shadow-lg hover:bg-pink-900" @click="toggleDateModal = !toggleDateModal">{{toggleDateModal}}</button> -->
